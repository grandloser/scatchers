defmodule Scatchers do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Scatchers.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    Scatchers.Endpoint.config_change(changed, removed)
    :ok
  end
end
